...
function google_application() {
    // history.replaceState(null, null, 'https://www.example.com/new-url');
    console.log(window.location.href);
    // console.log(123);
}
